...
parser.add_argument('-e', '--num_events', default=3,
                    type=int, action='store')
...
critical_density_ub = [0.8,0.8]
critical_self_density_lb = [0.01, 0.01]
critical_self_density_ub = [0.3, 0.3]
critical_xy_distance_lb = [1., 1.]
critical_xy_distance_ub = [2.5, 2.5]
...
# get default metrics
if args.default:
    defaults = [0.036,0.85,60,60,0.97,30,60,60,35,9,9,0.6,0.15,1.8,3,3.24,0.2,2]
...
objective = optimizer.Objective(reco_and_validate, 3)
...
pso = optimizer.MOPSO(objective=objective, lower_bounds=lb, upper_bounds=ub, 
            ...
            inertia_weight=0.3, cognitive_coefficient=1.5, social_coefficient=2.)
